...
//        assertTrue(loginPage.getMainButtonText().contains("ГЛАВНАЯ"));
        ...
        loginPage.login("AP","test");
        //Заполнить имя, фамилия, выбрать страну, адрес, город, область, индекс, телефон, адрес почты
        homePage.fillOrderDetails("Vasya", "Poupkin", "Russia", "Kreml ul.", "Kazan",
                "Tatarstan", "420108", "+74951234567", "ap@test.ru");
        ...
        assertEquals(homePage.getEmailOrder(), "ap@test.ru");
